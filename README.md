...
- [x] **Research ops：regime API + Lab WFO/DCA benchmark**
...
见 [`docs/CODESPACES.md`](docs/CODESPACES.md)。

研究作业流：[`docs/RESEARCH_OPS.md`](docs/RESEARCH_OPS.md)。行情 [`docs/MARKET.md`](docs/MARKET.md)；券商 [`docs/BROKER.md`](docs/BROKER.md)；Lab [`docs/LAB.md`](docs/LAB.md)；TV 导入 [`docs/TVIMPORT.md`](docs/TVIMPORT.md)。
